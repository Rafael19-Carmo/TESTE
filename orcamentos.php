...
<?php 
    ...
    if (isset($_POST['pesquisar'])){
        ...
        $sql = "select * from orcamento where nome like '$pesquisar%' and tipo = 1";
        include "conexao.php";
        $resultado = mysqli_query($conexao,$sql);
            ...
            while($linha = mysqli_fetch_array($resultado)){
                ...
                echo "<td><a href = 'arquivar.php'?id=$up>ARQUIVAR</a></td>";
                echo"</tr>";
            }
            echo "</table>";
    }
        ...
        $sql = "select * from orcamento where tipo = 1";
        include "conexao.php";
        $resultado = mysqli_query($conexao,$sql);
            echo"<table border = '1'>";
            echo "<tr>";
            ...
            while($linha = mysqli_fetch_array($resultado)){
                ...
                echo"<td>".$linha['data_hora']."</td>";
                echo"<td>".$linha['img_exemplo']."</td>";
                echo "<td><a href = 'arquivar.php?id=$up'>ARQUIVAR</td>";
